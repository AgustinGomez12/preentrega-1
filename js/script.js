//Nombre de alumno:Agustin Gomez
...
const indiseDeMasacorporal = (peso, altura) => {
    ...
    while (reintentarMedicion) {
        ...
        if (estadoDesalud == 15 || estadoDesalud == 16 || estadoDesalud == 17 || estadoDesalud == 18) {
            ...
            console.warn("⚠Error de IMC o limite excedido (CUIDADO)⚠")
            alert("⚠Error de IMC o limite excedido (CUIDADO)⚠")
        }
...
const tasaMetabolicaBasal = peso => {
    ...
    while (reintentarMedicion) {
        ...
        let pesoXparametroH = Math.round(peso * parametroHarrisBenedic)
        ...
        switch (preguntaDeActividadXdia) {
            ...
            case 5:
                ...
                break;
            default:
                console.warn("Error digito no encontrado")
...
const tipoDeCuerpo = (preguntaDeCalorias, preguntaDeMusculos) => {
    ...
    while (reintentarCalificacion) {
        ...
        if (preguntaDeCalorias == 1 && preguntaDeMusculos == 3 || preguntaDeCalorias == 1 && preguntaDeMusculos == 2 || preguntaDeCalorias == 2 && preguntaDeMusculos == 3) {
